        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="tengah"><h1 class="m-0 font-weight-bold text-primary">Kelas</h1></div>
                                    ...
                                    @foreach($kelas as $p)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="edit_kelas/{{$p->id_kelas}}" class="btn btn-success btn-sm"><i class="fas fa-edit fa-fw"></i>  </a>
                                                <a href="hapus_kelas/{{$p->id_kelas}}" class="btn btn-danger btn-sm"><i class="fas fa-trash fa-fw"></i> </a>
